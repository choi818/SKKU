...
class ArticleCrawler(object):
    ...
    def setDateRange(self, start_year, end_year, end_month):
    ...
    def crawling(self, category_name):
        ...
        # 각 카테고리 기사를 저장할 CSV
        file = open(category_name + ' 기사' + '.csv', 'w', encoding='euc_kr', newline='')
...
if __name__ == "__main__":
    ...
    Crawler.setCategory("정치")
    Crawler.setDateRange(2018, 2018, 1) # 2018년 1월부터 2019년 4월까지
    Crawler.start()
